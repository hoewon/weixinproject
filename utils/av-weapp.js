...
// 璁＄畻 X-LC-Sign 鐨勭鍚嶆柟娉�
      ...
      var createApiUrl = function createApiUrl(route, className, objectId, method, dataObject) {
        // TODO: 鍏煎 AV.serverURL 鏃ф柟寮忚缃� API Host锛屽悗缁幓鎺�
        if (AV.serverURL) {
...
// handle AV._request Error
      ...
      var setServerUrlByRegion = function setServerUrlByRegion() {
        ...
        getServerURLPromise = new Promise(function (resolve, reject) {
          // 濡傛灉鐢ㄦ埛鍦� init 涔嬪墠璁剧疆浜� APIServerURL锛屽垯璺宠繃璇锋眰 router
...
// All internal configuration items
        ...
        _.extend(AVConfig, {
          ...
          // 鏈嶅姟鍣ㄨ妭鐐瑰湴鍖猴紝榛樿涓浗澶ч檰
          region: 'cn',

          // 鏈嶅姟鍣ㄧ殑 URL锛岄粯璁ゅ垵濮嬪寲鏃惰璁剧疆涓哄ぇ闄嗚妭鐐瑰湴鍧€
          APIServerURL: AVConfig.APIServerURL || '',

          // 褰撳墠鏄惁涓� nodejs 鐜
          isNode: false,

          // 绂佺敤 currentUser锛岄€氬父鐢ㄤ簬澶氱敤鎴风幆澧�
   ...
   * }</pre>
        ...
        AV.File = function (name, data, type) {
          ...
          this.attributes = {
            ...
            url: '',
            metaData: {},
            // 鐢ㄦ潵瀛樺偍杞崲鍚庤涓婁紶鐨� base64 String
            base64: ''
          };
        ...
        AV.File.prototype = {
            ...
            var set = function set(attrName, value) {
              switch (attrName) {
                ...
                case 'metaData':
                  ...
                  break;
                default:
                  // File 骞堕潪涓€涓� AVObject锛屼笉鑳藉畬鍏ㄨ嚜瀹氫箟鍏朵粬灞炴€э紝鎵€浠ュ彧鑳介兘鏀惧湪 metaData 涓婇潰
          ...
          /**
           * 濡傛灉鏂囦欢鏄浘鐗囷紝鑾峰彇鍥剧墖鐨勭缉鐣ュ浘URL銆傚彲浠ヤ紶鍏ュ搴︺€侀珮搴︺€佽川閲忋€佹牸寮忕瓑鍙傛暟銆�
           * @return {String} 缂╃暐鍥綰RL
           * @param {Number} width 瀹藉害锛屽崟浣嶏細鍍忕礌
           * @param {Number} heigth 楂樺害锛屽崟浣嶏細鍍忕礌
           * @param {Number} quality 璐ㄩ噺锛�1-100鐨勬暟瀛楋紝榛樿100
           * @param {Number} scaleToFit 鏄惁灏嗗浘鐗囪嚜閫傚簲澶у皬銆傞粯璁や负true銆�
           * @param {String} fmt 鏍煎紡锛岄粯璁や负png锛屼篃鍙互涓簀peg,gif绛夋牸寮忋€�
           */
           ...
           * @param {Object} [options]
           * @param {UploadProgressCallback} [options.onprogress] 鏂囦欢涓婁紶杩涘害锛屽湪 Node.js 涓庡皬绋嬪簭涓棤鏁堬紝鍥炶皟鍙傛暟璇存槑璇﹁ {@link UploadProgressCallback}銆�
...
// 鍏煎鑰佺増鏈殑鍒濆鍖栨柟娉�
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      module.exports = function (AV) {
        /**
         * 鍖呭惈浜嗕娇鐢ㄤ簡 LeanCloud
         *  <a href='/docs/leaninsight_guide.html'>绂荤嚎鏁版嵁鍒嗘瀽鍔熻兘</a>鐨勫嚱鏁般€�
         * <p><strong><em>
         *   浠呭湪浜戝紩鎿庤繍琛岀幆澧冧笅鏈夋晥銆�
         * </em></strong></p>
         * @namespace
        ...
        _.extend(AV.Insight, /** @lends AV.Insight */{
          ...
          /**
           * 寮€濮嬩竴涓� Insight 浠诲姟銆傜粨鏋滈噷灏嗚繑鍥� Job id锛屼綘鍙互鎷垮緱鍒扮殑 id 浣跨敤
           * AV.Insight.JobQuery 鏌ヨ浠诲姟鐘舵€佸拰缁撴灉銆�
           * @param {Object} jobConfig 浠诲姟閰嶇疆鐨� JSON 瀵硅薄锛屼緥濡傦細<code><pre>
     ...
     *                   }
           *                  </pre></code>
           *               sql 鎸囧畾浠诲姟鎵ц鐨� SQL 璇彞锛� saveAs锛堝彲閫夛級 鎸囧畾灏嗙粨鏋滀繚瀛樺湪鍝紶琛ㄩ噷锛宭imit 鏈€澶� 1000銆�
           * @param {AuthOptions} [options]
           * @return {Promise} A promise that will be resolved with the result
           * of the function.
           */
          ...
          /**
           * 鐩戝惉 Insight 浠诲姟浜嬩欢锛岀洰鍓嶄粎鏀寔 end 浜嬩欢锛岃〃绀轰换鍔″畬鎴愩€�
           *  <p><strong><em>
           *     浠呭湪浜戝紩鎿庤繍琛岀幆澧冧笅鏈夋晥銆�
           *  </em></strong></p>
           * @param {String} event 鐩戝惉鐨勪簨浠讹紝鐩墠浠呮敮鎸� 'end' 锛岃〃绀轰换鍔″畬鎴�
           * @param {Function} 鐩戝惉鍥炶皟鍑芥暟锛屾帴鏀� (err, id) 涓や釜鍙傛暟锛宔rr 琛ㄧず閿欒淇℃伅锛�
           *                   id 琛ㄧず浠诲姟 id銆傛帴涓嬫潵浣犲彲浠ユ嬁杩欎釜 id 浣跨敤AV.Insight.JobQuery 鏌ヨ浠诲姟鐘舵€佸拰缁撴灉銆�
           *
           */
        ...
        /**
         * 鍒涘缓涓€涓璞★紝鐢ㄤ簬鏌ヨ Insight 浠诲姟鐘舵€佸拰缁撴灉銆�
         * @class
         * @param {String} id 浠诲姟 id
         * @since 0.5.5
         */
        ...
        AV.Insight.JobQuery.prototype = {
          ...
          /**
           * 鏌ヨ浠诲姟鐘舵€佸拰缁撴灉锛屼换鍔＄粨鏋滀负涓€涓� JSON 瀵硅薄锛屽寘鎷� status 琛ㄧず浠诲姟鐘舵€侊紝 totalCount 琛ㄧず鎬绘暟锛�
           * results 鏁扮粍琛ㄧず浠诲姟缁撴灉鏁扮粍锛宲reviewCount 琛ㄧず鍙互杩斿洖鐨勭粨鏋滄€绘暟锛屼换鍔＄殑寮€濮嬪拰鎴鏃堕棿
           * startTime銆乪ndTime 绛変俊鎭€�
           *
           * @param {AuthOptions} [options]
           * @return {Promise} A promise that will be resolved with the result
           * of the function.
...
// AV.Query is a way to create a list of AV.Objects.
   ...
   *   });
        ...
        AV.InboxQuery = AV.Query._extend( /** @lends AV.InboxQuery.prototype */{
          ...
          /**
           * Sets the maximal messageId of results銆�
           * This is useful for pagination.
   ...
   *   });
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      module.exports = function upload(uploadInfo, data, file) {
        ...
        file.id = uploadInfo.objectId;
        return new Promise(function (resolve, reject) {
          // 娴峰鑺傜偣锛岄拡瀵� S3 鎵嶄細杩斿洖 upload_url
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      module.exports = function (AV) {
        ...
        AV.User = AV.Object.extend("_User", /** @lends AV.User.prototype */{
          ...
          /**
           * 灏嗙敤鎴蜂笌灏忕▼搴忕敤鎴疯繘琛屽叧鑱斻€傞€傜敤浜庝负宸茬粡鍦ㄧ敤鎴风郴缁熶腑瀛樺湪鐨勭敤鎴峰叧鑱斿綋鍓嶄娇鐢ㄥ皬绋嬪簭鐨勫井淇″笎鍙枫€�
           * 浠呭湪灏忕▼搴忎腑鍙敤銆�
           *
           * @return {AV.User}
           */
           ...
           * @deprecated 濡傛灉瑕佸垽鏂綋鍓嶇敤鎴风殑鐧诲綍鐘舵€佹槸鍚︽湁鏁堬紝璇蜂娇鐢� currentUser.isAuthenticated().then()锛�
           * 濡傛灉瑕佸垽鏂鐢ㄦ埛鏄惁鏄綋鍓嶇櫥褰曠敤鎴凤紝璇蜂娇鐢� user.id === currentUser.id
           * @return (Boolean) whether this user is the current user and is logged in.
           */
          authenticated: function authenticated() {
            console.warn('DEPRECATED: 濡傛灉瑕佸垽鏂綋鍓嶇敤鎴风殑鐧诲綍鐘舵€佹槸鍚︽湁鏁堬紝璇蜂娇鐢� currentUser.isAuthenticated().then()锛屽鏋滆鍒ゆ柇璇ョ敤鎴锋槸鍚︽槸褰撳墠鐧诲綍鐢ㄦ埛锛岃浣跨敤 user.id === currentUser.id銆�');
            return !!this._sessionToken && !AV._config.disableCurrentUser && AV.User.current() && AV.User.current().id === this.id;
          },

          /**
           * 妫€鏌ヨ鐢ㄦ埛鐨勭櫥褰曠姸鎬佹槸鍚︽湁鏁堬紝璇锋敞鎰忚鏂规硶浼氭牎楠� sessionToken 鐨勬湁鏁堟€э紝鏄釜寮傛鏂规硶銆�
           *
           * @since 2.0.0
     ...
     * });
           * @see {@link https://leancloud.cn/docs/js_guide.html#缁戝畾绗笁鏂瑰钩鍙拌处鎴穧
     */
          ...
          /**
           * 浣跨敤褰撳墠浣跨敤灏忕▼搴忕殑寰俊鐢ㄦ埛韬唤娉ㄥ唽鎴栫櫥褰曪紝鎴愬姛鍚庣敤鎴风殑 session 浼氬湪璁惧涓婃寔涔呭寲淇濆瓨锛屼箣鍚庡彲浠ヤ娇鐢� AV.User.current() 鑾峰彇褰撳墠鐧诲綍鐢ㄦ埛銆�
           * 浠呭湪灏忕▼搴忎腑鍙敤銆�
           *
           * @since 2.0.0
           * @return {AV.User}
